...
<main id="main-content">
  ...
  <section class="hero-section" id="hero" aria-label="Hero section">
    ...
    <div class="hero-img-panel" aria-hidden="true">
    ...
    <div class="container hero-container">
      <div class="hero-content" data-reveal="up">
        <p class="hero-accent-label">
          <i class="bi bi-water" aria-hidden="true"></i>
          STAY BY THE COAST
        </p>
        <h1 class="hero-heading">
          Your Relaxed Stay<br>
          in <span class="hero-heading-accent">Hiriketiya.</span>
        </h1>
        <p class="hero-subtext">
          Affordable, comfortable stays near the beach for couples, solo travelers,
          friends and families exploring Sri Lanka's south coast.
        </p>
        <div class="hero-buttons">
          <a href="rooms.php" class="btn btn-hero-primary" id="heroExploreRoomsBtn">
            Explore Our Rooms <i class="bi bi-arrow-right" aria-hidden="true"></i>
          </a>
          <a href="booking.php" class="btn btn-hero-secondary" id="heroBookBtn">Book Your Stay</a>
        </div>
        <div class="hero-pills" aria-label="Quick highlights">
          <span class="hero-pill">Only 5 Rooms</span>
          <span class="hero-pill">Flexible Stays</span>
          <span class="hero-pill">Near Hiriketiya</span>
        </div>
      </div>
    </div>

    <!-- Floating badges (hidden on mobile) -->
    <div class="hero-location-pill" aria-hidden="true">
      <i class="bi bi-geo-alt-fill" aria-hidden="true"></i>
      South Coast, Sri Lanka
    </div>

    <div class="hero-star-badge" aria-hidden="true">
      <i class="bi bi-star-fill text-warning" aria-hidden="true"></i>
      Hiriketiya's Favourite Stay
    </div>
    ...
    <div class="brand-wave-inner">
      <div class="brand-marquee-wrap">
        <div class="brand-marquee">
          ...
          <span class="brand-marquee-dot">·</span>
          <span class="brand-marquee-item">SURF CULTURE</span>
          <span class="brand-marquee-dot">·</span>
          <span class="brand-marquee-item">DENVONBAY</span>
          <span class="brand-marquee-dot">·</span>
          <span class="brand-marquee-item brand-marquee-aqua">HIRIKETIYA</span>
  ...
  <section class="surf-lifestyle-section" id="surf-lifestyle" aria-label="Surf lifestyle at Hiriketiya">
    <div class="surf-lifestyle-inner" data-reveal="up">
      <img src="assets/images/explore/Surfer_carving_ocean_barrel_2K_202607210258.jpg"
           alt="Surfer carving through an ocean barrel at Hiriketiya, Sri Lanka"
           class="surf-lifestyle-img" loading="lazy">
      <div class="surf-lifestyle-overlay" aria-hidden="true"></div>
      <div class="surf-lifestyle-content">
        <p class="surf-lifestyle-label">
          <i class="bi bi-tsunami" aria-hidden="true"></i>
          Hiriketiya South Coast
        </p>
        <h2 class="surf-lifestyle-heading">Wake.<br>Surf.<br>Slow Down.</h2>
        <p class="surf-lifestyle-subtext">
          Spend your mornings in the water and your afternoons exploring
          Sri Lanka's breathtaking south coast.
        </p>
        <a href="explore.php" class="btn btn-cta-primary" id="surfExploreBtn">
          Explore Hiriketiya <i class="bi bi-arrow-right ms-1" aria-hidden="true"></i>
        </a>
      </div>
    </div>
  </section>
  ...
  <section class="experiences-section" id="experiences" aria-label="Experiences at Denvonbay">
    <div class="container">
      <div class="section-header text-center" data-reveal="up">
        ...
        <h2 class="section-heading text-white">More Than a Place to Sleep.</h2>
        <p class="section-subtext">Immerse yourself in the best of Hiriketiya's coastal lifestyle.</p>
      </div>
      <div class="experiences-grid">

        <!-- Large card: Surfing -->
        <article class="exp-card exp-card--large" data-reveal="left" data-reveal-delay="0">
          ...
          <div class="exp-card-label">
            <div class="exp-card-label-icon"><i class="bi bi-tsunami" aria-hidden="true"></i></div>
            ...
            <div class="exp-card-arrow"><i class="bi bi-arrow-right" aria-hidden="true"></i></div>
          </div>
        </article>

        <!-- Small card: Dining -->
        <article class="exp-card exp-card--sm" data-reveal="up" data-reveal-delay="100">
          <div class="exp-card-image-wrap">
            <img src="assets/images/explore/Woman_lying_on_beach_towel_202607210218.jpg"
                 alt="Relaxed coastal lifestyle near Hiriketiya" class="exp-card-img" loading="lazy">
          </div>
          <div class="exp-card-label">
            <div class="exp-card-label-icon"><i class="bi bi-cup-straw" aria-hidden="true"></i></div>
            <div class="exp-card-label-body">
              <h3 class="exp-card-title">Dining</h3>
              <p class="exp-card-desc">Local cafes and coastal flavours at your door.</p>
            </div>
            <div class="exp-card-arrow"><i class="bi bi-arrow-right" aria-hidden="true"></i></div>
          </div>
        </article>
        ...
        <!-- Small card: Yoga -->
        <article class="exp-card exp-card--sm" data-reveal="up" data-reveal-delay="200">
          <div class="exp-card-image-wrap">
            <img src="assets/images/explore/Woman_practicing_yoga_on_rooftop_202607210327.jpg"
                 alt="Woman practicing yoga with ocean views" class="exp-card-img" loading="lazy">
          </div>
          <div class="exp-card-label">
            <div class="exp-card-label-icon"><i class="bi bi-heart-pulse" aria-hidden="true"></i></div>
            <div class="exp-card-label-body">
              <h3 class="exp-card-title">Yoga & Wellness</h3>
              <p class="exp-card-desc">Mindful mornings and slow coastal evenings.</p>
            </div>
            <div class="exp-card-arrow"><i class="bi bi-arrow-right" aria-hidden="true"></i></div>
          </div>
        </article>

        <!-- Small card: Beach Days -->
        <article class="exp-card exp-card--sm" data-reveal="up" data-reveal-delay="300">
          <div class="exp-card-image-wrap">
            <img src="assets/images/explore/Friends_walking_on_beach_202607210209.jpg"
                 alt="Friends enjoying the beach near Hiriketiya" class="exp-card-img" loading="lazy">
          </div>
          <div class="exp-card-label">
            <div class="exp-card-label-icon"><i class="bi bi-sun" aria-hidden="true"></i></div>
            <div class="exp-card-label-body">
              <h3 class="exp-card-title">Beach Days</h3>
              <p class="exp-card-desc">Golden afternoons on Hiriketiya Bay's crescent shore.</p>
            </div>
            <div class="exp-card-arrow"><i class="bi bi-arrow-right" aria-hidden="true"></i></div>
          </div>
        </article>

        <!-- Small card: Accommodation -->
        <article class="exp-card exp-card--sm" data-reveal="right" data-reveal-delay="200">
          <div class="exp-card-image-wrap">
            <img src="assets/images/explore/White_spa_slippers_on_beach_202607210209.jpg"
                 alt="Comfortable coastal accommodation at Denvonbay" class="exp-card-img" loading="lazy">
          </div>
          <div class="exp-card-label">
            <div class="exp-card-label-icon"><i class="bi bi-house-heart" aria-hidden="true"></i></div>
            <div class="exp-card-label-body">
              <h3 class="exp-card-title">Comfortable Stays</h3>
              <p class="exp-card-desc">Five rooms, thoughtfully designed for slow travel.</p>
            </div>
            <div class="exp-card-arrow"><i class="bi bi-arrow-right" aria-hidden="true"></i></div>
          </div>
        </article>
    ...
    <div class="container">
      ...
      <div class="why-grid">
        <div class="why-item" data-reveal="up" data-reveal-delay="0">
          <div class="why-number" aria-hidden="true">01</div>
          <div class="why-body">
            <h3 class="why-title">Only Five Rooms</h3>
            <p class="why-desc">A smaller property means a quieter and more personal stay. No crowded hallways. No resort chaos. Just your own coastal escape.</p>
          </div>
        </div>
        <div class="why-item" data-reveal="up" data-reveal-delay="80">
          <div class="why-number" aria-hidden="true">02</div>
          <div class="why-body">
            <h3 class="why-title">Flexible Packages</h3>
            <p class="why-desc">Choose daytime, overnight, weekend or longer-stay options. We fit around your travel style, not the other way around.</p>
          </div>
        </div>
        <div class="why-item" data-reveal="up" data-reveal-delay="160">
          <div class="why-number" aria-hidden="true">03</div>
          <div class="why-body">
            <h3 class="why-title">Close to the Coast</h3>
            <p class="why-desc">Easy access to Hiriketiya Beach, local cafes, and surf culture — all within a short walk from your front door.</p>
          </div>
        </div>
        <div class="why-item" data-reveal="up" data-reveal-delay="240">
          <div class="why-number" aria-hidden="true">04</div>
          <div class="why-body">
            <h3 class="why-title">Affordable Comfort</h3>
            <p class="why-desc">Relax in thoughtfully-styled rooms without paying premium resort prices. Great value, genuine hospitality.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="rooms-section" id="rooms-preview" aria-label="Room preview">
    <div class="container">
      <div class="section-header text-center" data-reveal="up">
        ...
        <h2 class="section-heading-dark">Stay Your Way.</h2>
        <p class="section-subtext-dark">Five rooms. Each with its own character.</p>
      </div>
      <div class="rooms-editorial-grid">
        <?php if (!empty($featuredRooms)): ?>
          ...
          ?>
            <article class="<?= $cardClass ?>" id="room-<?= e($fRoom['slug']) ?>" data-reveal="up" data-reveal-delay="<?= $delay ?>">
              ...
              <div class="room-card-body">
                ...
                <div class="room-card-meta">
                  <span class="room-meta-item"><i class="bi bi-person-fill" aria-hidden="true"></i><?= (int)$fRoom['capacity'] ?> Guest<?= $fRoom['capacity'] > 1 ? 's' : '' ?></span>
                  <span class="room-meta-item"><i class="bi bi-wifi" aria-hidden="true"></i>Wi-Fi</span>
                  <span class="room-meta-item"><i class="bi bi-geo-alt" aria-hidden="true"></i>Near Beach</span>
                </div>
                <a href="rooms.php#<?= e($fRoom['slug']) ?>" class="<?= $btnClass ?>">
                  View Room <i class="bi bi-arrow-right" aria-hidden="true"></i>
                </a>
              </div>
            </article>
          <?php endforeach; ?>
        <?php else: ?>
          <article class="room-card" id="room-cozy" data-reveal="up" data-reveal-delay="0">
            <div class="room-card-image-wrap">
              <img src="assets/images/explore/Surfboard_logo_detail_macro_shot_202607210209.jpg"
                   alt="The Cozy Room at Denvonbay" class="room-card-img" loading="lazy">
            ...
            <div class="room-card-body">
              ...
              <div class="room-card-meta">
                <span class="room-meta-item"><i class="bi bi-person-fill" aria-hidden="true"></i>1 Guest</span>
                <span class="room-meta-item"><i class="bi bi-wifi" aria-hidden="true"></i>Wi-Fi</span>
                <span class="room-meta-item"><i class="bi bi-moon-stars" aria-hidden="true"></i>Peaceful</span>
              </div>
              <a href="rooms.php#cozy" class="btn btn-room-view" id="viewCozyRoomBtn">
                View Room <i class="bi bi-arrow-right" aria-hidden="true"></i>
              </a>
            </div>
          </article>

          <article class="room-card room-card--featured" id="room-couples" data-reveal="up" data-reveal-delay="150">
            <div class="room-card-image-wrap">
            ...
            <div class="room-card-body">
              ...
              <div class="room-card-meta">
                <span class="room-meta-item"><i class="bi bi-people-fill" aria-hidden="true"></i>2 Guests</span>
                <span class="room-meta-item"><i class="bi bi-wifi" aria-hidden="true"></i>Wi-Fi</span>
                <span class="room-meta-item"><i class="bi bi-heart" aria-hidden="true"></i>Romantic</span>
              </div>
              <a href="rooms.php#couples" class="btn btn-room-view btn-room-view--primary" id="viewCouplesRoomBtn">
                View Room <i class="bi bi-arrow-right" aria-hidden="true"></i>
              </a>
            </div>
          </article>

          <article class="room-card" id="room-friends" data-reveal="up" data-reveal-delay="300">
            <div class="room-card-image-wrap">
              <img src="assets/images/explore/Friends_walking_on_beach_202607210209.jpg"
            ...
            <div class="room-card-body">
              ...
              <div class="room-card-meta">
                <span class="room-meta-item"><i class="bi bi-people-fill" aria-hidden="true"></i>3–4 Guests</span>
                <span class="room-meta-item"><i class="bi bi-wifi" aria-hidden="true"></i>Wi-Fi</span>
                <span class="room-meta-item"><i class="bi bi-sun" aria-hidden="true"></i>Lively</span>
              </div>
              <a href="rooms.php#friends" class="btn btn-room-view" id="viewFriendsRoomBtn">
                View Room <i class="bi bi-arrow-right" aria-hidden="true"></i>
              </a>
            </div>
          </article>
      ...
      <div class="text-center mt-5" data-reveal="up">
        <a href="rooms.php" class="btn btn-view-all" id="viewAllRoomsBtn">
          View All 5 Rooms <i class="bi bi-arrow-right ms-1" aria-hidden="true"></i>
        </a>
      </div>
    </div>
  </section>
  ...
  <section class="packages-section" id="packages-preview" aria-label="Stay packages">
    <div class="packages-bg">
      <div class="container">
        <div class="section-header text-center" data-reveal="up">
          ...
          <h2 class="section-heading text-white">Stay a Little Longer.</h2>
          <p class="section-subtext">From a quick escape to a slow island stay — we have the right package for you.</p>
        </div>
        <div class="packages-grid">
          <?php if (!empty($featuredPackages)): ?>
            ...
            ?>
              <article class="<?= $pCardClass ?>" data-reveal="up" data-reveal-delay="<?= $pDelay ?>">
                ...
                <?php endif; ?>
                <div class="pkg-card-icon"><i class="bi <?= e($icon) ?>" aria-hidden="true"></i></div>
                <h3 class="pkg-card-title"><?= e($pkgTitle) ?></h3>
                <p class="pkg-card-duration"><i class="bi bi-clock" aria-hidden="true"></i><?= e($fPkg['duration'] ?? '') ?></p>
          ...
          <?php else: ?>
            <article class="pkg-card" data-reveal="up" data-reveal-delay="0">
              <div class="pkg-card-icon"><i class="bi bi-sun" aria-hidden="true"></i></div>
              <h3 class="pkg-card-title">Day Escape</h3>
              <p class="pkg-card-duration"><i class="bi bi-clock" aria-hidden="true"></i>Daytime stay</p>
            ...
            <article class="pkg-card pkg-card--highlight" data-reveal="up" data-reveal-delay="100">
              ...
              <div class="pkg-card-icon"><i class="bi bi-moon-stars" aria-hidden="true"></i></div>
              <h3 class="pkg-card-title">One Night Getaway</h3>
              <p class="pkg-card-duration"><i class="bi bi-clock" aria-hidden="true"></i>1 Night</p>
            ...
            <article class="pkg-card" data-reveal="up" data-reveal-delay="200">
              <div class="pkg-card-icon"><i class="bi bi-calendar2-week" aria-hidden="true"></i></div>
              <h3 class="pkg-card-title">Weekend Escape</h3>
              <p class="pkg-card-duration"><i class="bi bi-clock" aria-hidden="true"></i>2 Nights</p>
            ...
            <article class="pkg-card" data-reveal="up" data-reveal-delay="300">
              <div class="pkg-card-icon"><i class="bi bi-tropical-storm" aria-hidden="true"></i></div>
              <h3 class="pkg-card-title">Slow Island Stay</h3>
              <p class="pkg-card-duration"><i class="bi bi-clock" aria-hidden="true"></i>3+ Nights</p>
        ...
        <div class="text-center mt-5" data-reveal="up">
          <a href="packages.php" class="btn" style="background: rgba(255,255,255,0.12); color: var(--white); border: 1.5px solid rgba(255,255,255,0.35); padding: 14px 32px; border-radius: 9999px; font-weight: 600;">
            View All Packages <i class="bi bi-arrow-right ms-1" aria-hidden="true"></i>
          </a>
        </div>
      </div>
    </div>
    <div class="packages-wave-bottom" aria-hidden="true">
      <svg viewBox="0 0 1440 60" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M0,30 C480,60 960,0 1440,30 L1440,60 L0,60 Z" fill="#FAF9F6"/>
      </svg>
    </div>
  </section>
      ...
      <div class="row align-items-center gy-5">
        <div class="col-lg-6" data-reveal="left">
          <div class="explore-image-wrap">
            ...
            <div class="explore-img-badge">
              <i class="bi bi-geo-alt-fill" aria-hidden="true"></i>Hiriketiya, Sri Lanka
            </div>
          </div>
        </div>
        <div class="col-lg-6" data-reveal="right">
          <div class="explore-content">
            ...
            <p class="explore-text">
              Spend your days at the beach, try surfing, discover local cafes, explore nearby coastal attractions
              and enjoy the relaxed rhythm of Hiriketiya. The south coast is yours to discover.
            </p>
            <div class="explore-chips" role="list" aria-label="Nearby destinations">
              <span class="explore-chip" role="listitem"><i class="bi bi-water" aria-hidden="true"></i>Hiriketiya Beach</span>
              <span class="explore-chip" role="listitem"><i class="bi bi-water" aria-hidden="true"></i>Dickwella Beach</span>
              <span class="explore-chip" role="listitem"><i class="bi bi-water" aria-hidden="true"></i>Blue Beach Island</span>
              <span class="explore-chip" role="listitem"><i class="bi bi-cup-hot" aria-hidden="true"></i>Local Cafés</span>
            </div>
            <a href="explore.php" class="btn-explore-cta" id="exploreNearbyBtn">
              Explore Nearby <i class="bi bi-arrow-right" aria-hidden="true"></i>
            </a>
          </div>
        </div>
      </div>
              ...
              <article class="<?= $rFeatured ?>">
                ...
                <footer class="testi-footer">
                  <div class="testi-stars" aria-label="<?= (int)$rev['rating'] ?> out of 5 stars">
                    <?php for ($s = 1; $s <= 5; $s++): ?>
                      <i class="bi bi-star<?= $s <= $rev['rating'] ? '-fill' : '' ?>" aria-hidden="true"></i>
                    <?php endfor; ?>
                  </div>
                  <p class="testi-author"><?= e($rev['guest_name']) ?></p>
                  <?php if (!empty($rev['location'])): ?>
                    <p class="testi-location"><i class="bi bi-geo-alt" aria-hidden="true"></i><?= e($rev['location']) ?></p>
                  <?php endif; ?>
                </footer>
              </article>
            </div>
          ...
          <div class="col-lg-4 col-md-6" data-reveal="up" data-reveal-delay="0">
            <article class="testi-card">
              ...
              <footer class="testi-footer">
                ...
                <p class="testi-location"><i class="bi bi-geo-alt" aria-hidden="true"></i>Melbourne, Australia</p>
              </footer>
            </article>
          </div>
          ...
          <div class="col-lg-4 col-md-6" data-reveal="up" data-reveal-delay="150">
            <article class="testi-card testi-card--featured">
              ...
              <footer class="testi-footer">
                ...
                <p class="testi-location"><i class="bi bi-geo-alt" aria-hidden="true"></i>Milan, Italy</p>
              </footer>
            </article>
          </div>
          ...
          <div class="col-lg-4 col-md-6" data-reveal="up" data-reveal-delay="300">
            <article class="testi-card">
              ...
              <footer class="testi-footer">
                ...
                <p class="testi-location"><i class="bi bi-geo-alt" aria-hidden="true"></i>Berlin, Germany</p>
              </footer>
            </article>
          </div>
        <?php endif; ?>
  ...
  <section class="final-cta-section" id="final-cta"
           style="background-image: url('assets/images/explore/Woman_lying_on_beach_towel_202607210218 (1).jpg');"
           aria-label="Book your stay at Denvonbay">
    <div class="container">
      <div class="final-cta-inner" data-reveal="up">
        <p class="final-cta-eyebrow"><i class="bi bi-water" aria-hidden="true"></i>Hiriketiya Awaits</p>
        <h2 class="final-cta-heading">
          Ready for Slow Days<br>
          <span class="final-cta-accent">by the Coast?</span>
        </h2>
        <p class="final-cta-text">
          Choose your room, find the package that suits your trip, and make Denvonbay
          part of your Sri Lankan adventure.
        </p>
        <div class="final-cta-buttons">
          <a href="booking.php" class="btn btn-cta-primary" id="finalCtaCheckBtn">
            <i class="bi bi-calendar2-check" aria-hidden="true"></i>Check Availability
          </a>
          <a href="https://wa.me/<?= preg_replace('/[^0-9]/', '', $whatsappNumber) ?>"
             target="_blank" rel="noopener"
             class="btn btn-cta-whatsapp" id="finalCtaWhatsappBtn"
             aria-label="Book via WhatsApp">
            <i class="bi bi-whatsapp" aria-hidden="true"></i>Book via WhatsApp
          </a>
        </div>
      </div>
    </div>
